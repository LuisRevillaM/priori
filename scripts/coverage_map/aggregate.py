...
ROADMAP_IMPLICATIONS = [
    ...
    "off_ball_run landed as observed off-ball endpoint-window movement; named run typing, decoy/marker-dragging, space-creation, coordination, and path-purpose claims remain precise next blockers.",
...
PRIMITIVE_ALIASES = {
    ...
    "off_ball_run (run typing)": "off_ball_run_type_or_path",
    "off_ball_run (phased run typing)": "off_ball_run_type_or_path",
    "off_ball_run (trajectory curvature)": "off_ball_run_type_or_path",
    "off_ball_run (coordination/run typing)": "off_ball_run_type_or_path",
    "off_ball_run (multi-player coordination)": "off_ball_run_type_or_path",
    "off_ball_run (third-man run typing)": "off_ball_run_type_or_path",
    "off_ball_run (set-piece run context)": "off_ball_run_type_or_path",
    "marking": "marking_assignment_or_scheme",
    "off_ball_run + marking": "marking_assignment_or_scheme",
    "off_ball_run + time_to_arrival": "space_region_generation",
...
def main() -> None:
    ...
    report = {
        ...
        "catalog_basis": "codex/afl08-passport-loop substrate after Q5, time_to_arrival static-point reachability, carry_episode movement-under-control, Q2 generic binary episode joins, acceleration, set_piece_structure observed restart arrangement, off_ball_run observed movement, and marking observed proximity",
