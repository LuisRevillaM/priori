...
ROADMAP_IMPLICATIONS = [
    ...
    "team_press landed as observed multi-defender pressure geometry around a carrier; trap/trigger plans, coordination intent, synchrony windows, and pressure quality remain precise next blockers.",
...
PRIMITIVE_ALIASES = {
    ...
    "off_ball_run (run typing)": "off_ball_run_purpose_or_role",
    "off_ball_run (phased run typing)": "off_ball_run_phase_or_sequence",
    "off_ball_run (trajectory curvature)": "off_ball_run_curvature",
    "off_ball_run (coordination/run typing)": "off_ball_run_coordination",
    "off_ball_run (multi-player coordination)": "off_ball_run_coordination",
    "off_ball_run (third-man run typing)": "off_ball_run_purpose_or_role",
    "off_ball_run (set-piece run context)": "off_ball_run_context_or_pattern",
    "marking": "marking_assignment_or_scheme",
    "off_ball_run + marking": "marking_assignment_or_scheme",
    "off_ball_run + time_to_arrival": "space_creation_or_space_effect",
