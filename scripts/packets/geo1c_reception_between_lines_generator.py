...
OUT_DIR = Path("delivery/packets/geo-1c-reception-between-lines")
MEANING_PATH = OUT_DIR / "meaning-expression.json"
PLAN_PATH = OUT_DIR / "reception_between_observed_lines.v2.json"
TABLE_PATH = OUT_DIR / "reception_between_observed_lines_v2_table.json"
TABLE_MD_PATH = OUT_DIR / "reception_between_observed_lines_v2_table.md"
...
def synthesized_plan_bundle() -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    for role in ROLE_ORDER:
        ...
        document["recipe"]["recipe_id"] = "reception_between_observed_lines_v2"
        document["draft_plan"]["recipe_id"] = "reception_between_observed_lines_v2"
...
def build_table(
    *,
    ...
    return {
        ...
        "rows": rows,
        "schema_version": "geo1c.reception_between_observed_lines.certified_table.v1",
        "synthesis": {
...
def main() -> int:
    ...
    provenance = {
        ...
        "generated_by": "scripts/packets/geo1c_reception_between_lines_generator.py",
        ...
        "schema_version": "geo1c.reception_between_observed_lines.provenance.v1",
