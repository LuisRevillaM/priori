...
OUT_DIR = Path("delivery/packets/geo-1d-reception-between-lines")
MEANING_PATH = OUT_DIR / "meaning-expression.json"
PLAN_PATH = OUT_DIR / "reception_between_observed_lines.v3.json"
TABLE_PATH = OUT_DIR / "reception_between_observed_lines_v3_table.json"
TABLE_MD_PATH = OUT_DIR / "reception_between_observed_lines_v3_table.md"
...
POPULATION_EXPRESSION = (
    "receptions between the receiver-relative adjacent observed geometric line pair, "
...
def synthesized_plan_bundle() -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    for role in ROLE_ORDER:
        ...
        line_node.setdefault("parameters", {})["line_collection_scope"] = enum(
            "all_opposing_lines"
        )
        line_node["version"] = "0.2.0"
        between_node.setdefault("parameters", {})["line_selector"] = enum(
        ...
        document["recipe"]["recipe_id"] = "reception_between_observed_lines_v3"
        document["draft_plan"]["recipe_id"] = "reception_between_observed_lines_v3"
        document["recipe"]["display_name"] = "Reception Between Observed Lines"
        document["recipe"]["allowed_claims"] = [
            "Signed receiver geometry between the unique adjacent observed line pair bracketing the receiver and interval rates over controlled receptions."
        ]
...
def build_table(
    *,
    ...
    return {
        ...
        "question": "How often does each receiver receive between receiver-relative adjacent observed lines?",
        "rows": rows,
        "schema_version": "geo1d.reception_between_observed_lines.certified_table.v1",
        "synthesis": {
...
def main() -> int:
    ...
    provenance = {
        ...
        "generated_by": "scripts/packets/geo1d_reception_between_lines_generator.py",
        ...
        "schema_version": "geo1d.reception_between_observed_lines.provenance.v1",
