...
# SCP2-3 Round 3: ACCEPT-WITH-FIXES

Reviewed 2026-07-06 at c7c9b8d. Verified by the director's hand: the
evidence self-stamps match the committed script (hash inside every
artifact, PNG metadata included); 115/115 chain moments, source_kind
derived from real chain records; witness-derived replay windows (603
frames on the exhibited PASS chain); stage labels and carry trails
rendered on the turf; UNKNOWN moments in slate with truncation
reasons; the cold ask's interval honestly labeled RUNTIME with
certified_table null; the DELIVERED-with-evidence report language
adopted. Director's full suite green. The four charter laws render
on committed, script-produced evidence.

**The one fix (F-R2-4, fence repair):** round 3 regenerated the R2-4
flagship plan in place to add witness evidence — obeying this
review's own round-3 order ("through BOTH plans"), which was written
without noticing it conflicts with the sealed-evidence fence. The
fault is the ruling's; the executor took the least-bad path via the
committed generator. But R2-4's closed record must reproduce: its
review cites bf127689… byte-identity that the mutated files no longer
satisfy (rule 16). Fix: restore delivery/packets/r2-4-flagship/ to
its merged state; house the witness-enriched regeneration under
delivery/packets/scp2-3-evidence/witness-plan/ with its own
provenance (generated by R2-4's committed generator, hashes stated);
point the Film Room prewarm/committed-plan references there; fresh
evidence run. Nothing else changes.
