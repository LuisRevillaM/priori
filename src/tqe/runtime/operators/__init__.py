...
from tqe.runtime.operators.rate_and_share import RATE_AND_SHARE_SIGNATURE
...
OPERATOR_IMPLEMENTATION_NAMES: tuple[tuple[str, str, str], ...] = (
    ...
    ("rate_and_share", "0.1.0", "execute_rate_and_share"),
)
OPERATOR_IMPLEMENTATION_MODULES: dict[str, str] = {
    ...
    "execute_rate_and_share": "tqe.runtime.operators.rate_and_share",
