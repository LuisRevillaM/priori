...
RUNTIME_CONTEXTS: list[dict[str, Any]] = [
    ...
    {
        "name": "canonical_match_state.possession_role",
        "temporal_type": "frame_signal",
        "payload_type": "enum",
        "cardinality": "single",
        "unit": "none",
        "entity_scope": "team",
        "required": True,
        "description": "Canonical per-frame possession team role for the selected perspective.",
    },
    {
        "name": "canonical_match_state.ball_alive",
        "temporal_type": "frame_signal",
        ...
        "entity_scope": "ball",
        "required": True,
        "description": "Canonical per-frame ball-alive status.",
    },
    {
